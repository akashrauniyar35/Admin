...
const ConfirmBookingModal = ({ onPress, animation, isOpen, title, onClose, id, customerName, quoteReference, price, phone }: any) => {
                ...
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.transparentGloss, }}>
                    ...
                    <View style={{
                        ...
                        <View style={styles.container}>
                            ...
                            <Text style={{ fontSize: 12, color: Colors.grayOne, fontWeight: isAndroid ? "900" : "600" }}>Are you sure you want to confirm this quote to booking?</Text>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                ...
                                <Pressable style={[styles.save, { flexDirection: 'row', alignItems: 'center' }]} onPress={onPress}>
                                    <Text style={{ color: 'white', fontSize: 16, fontWeight: isAndroid ? "900" : "600" }}>{loading ? 'Loading' : 'Confirm'}</Text>
