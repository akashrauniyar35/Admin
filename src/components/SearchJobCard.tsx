        ...
        <>
            <Pressable onPress={onPress}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', }}>
                    <View style={{}}>
                        <Text style={{ fontSize: 16, fontFamily: 'Outfit-Bold', color: Colors.madidlyThemeBlue, marginBottom: isAndroid ? Colors.spacing * .5 : Colors.spacing * 1 }}>#{jobNumber}</Text>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', width: isAndroid ? '20%' : '25%' }}>
                        <Text style={{ fontSize: 16, fontFamily: 'Outfit-Medium', color: Colors.madidlyThemeBlue }}>$ </Text>
                        <Text style={{ fontSize: 16, fontFamily: 'Outfit-Medium', color: Colors.madidlyThemeBlue, }}>{parseInt(price).toFixed(2)}</Text>
                    </View>
                </View>
            </Pressable>
        </>
