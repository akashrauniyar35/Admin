...
const Profile = ({ navigation }) => {
    ...
    const uploadProfileHandler = async () => {
        ...
        updateProfilePic(result.assets[0], pic, id)
    }
        ...
        <>
            <View style={styles.container}>
                ...
                <ScrollView style={{ marginTop: Colors.spacing * 2, marginBottom: Colors.spacing * 3 }}>
                    {loading ? <ActivityIndicator color={Colors.madidlyThemeBlue} size={'large'} animating={loading} style={{ marginTop: HEIGHT * .4 }} /> :
                        <View style={{ paddingHorizontal: Colors.spacing * 2, }}>
                            ...
                            <Text style={{ fontSize: 16, color: Colors.black, fontWeight: isAndroid ? "900" : "700" }}>{'uploadingToggle'}</Text>
