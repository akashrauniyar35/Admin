...
const Bookings = ({ navigation }) => {
    ...
    return (
        <>
            <View style={styles.container}>
                ...
                <View style={{ paddingHorizontal: Colors.spacing * 2, }}>
                    <View style={{ marginVertical: Colors.spacing * 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={{ width: '35%', }}>
                            <Donut lable={"Total Bookings"} percentage={150} max={200} radius={40} color={Colors.madidlyThemeBlue} />
                        </View>
                        <View style={{ width: '60%' }}>
                            <QuoteBanner />
                        </View>
            ...
            <ViewBookingModal isOpen={openBooking} onClose={() => { setOpenBooking(false), setPageCount(1) }} id={selectedBooking?._id} refresh={viewBookingHandler} deleteHandler={deleteBookingHandler} deleteOpen={deleteBooking} toggleDelete={() => setDeleteBooking(!deleteBooking)} />
